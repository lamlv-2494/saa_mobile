        ...
        children: [
          ...
          ...recipients.map(
            (r) => Padding(
              ...
              child: _RecipientRow(ranking: r, onTap: onUserTap),
            ),
          ),
        ],
      ),
...
class _RecipientRow extends StatelessWidget {
  const _RecipientRow({required this.ranking, this.onTap});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: onTap != null ? () => onTap!(ranking.user.id) : null,
      child: Row(
        children: [
          CircleAvatar(
            radius: 14,
