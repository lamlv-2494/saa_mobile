...
class _$UserSummaryImpl implements _UserSummary {
  ...
  @override
  String toString() {
    return 'UserSummary(id: $id, name: $name, avatar: $avatar, department: $department, badgeLevel: $badgeLevel)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, avatar, department, badgeLevel);
