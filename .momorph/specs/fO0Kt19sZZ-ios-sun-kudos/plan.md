...
│               ├── highlight_kudos_card.dart        # B.3 Highlight card
...
│               ├── kudos_feed_card.dart             # C.3 Feed card
...
### Files đã tạo/sửa (final)

**Tạo mới**: 41 files trong `lib/features/kudos/` (models + generated + datasource + repository + viewmodel + screen + 15 widgets)
**Sửa**: `main_scaffold.dart`, `app_colors.dart`, `section_header_widget.dart`, `pubspec.yaml`, `strings_vi.i18n.json`, `strings_en.i18n.json`, `auth_remote_datasource.dart`, `auth_repository.dart`, `auth_viewmodel.dart`
**Migration**: `20260413000000_add_users_insert_policy.sql`
**Seed data**: `seed_kudos_mock.sql` (15 users, 28+ kudos, 109 reactions)
